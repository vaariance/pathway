...
const Header = ({ children }: PropsWithChildren) => {
  return (
    <div className="fixed top-0 z-30 w-full flex-col">
      <div className="relative flex h-20 justify-center">
        <div className="w-full max-w-screen-2xl backdrop-blur-lg bg-background/75 gap-8 flex flex-row items-center justify-between px-4">
...
export const ConnectButton = () => {
  ...
  return (
    <WalletWrapper>
      {(address, connected, disconnect, name, avatar, balance, Connector) =>
        connected ? (
          <Internal
            trigger={
              <Button
